  ...
  template: `
    ...
    >
      ...
      <div class="col-span-full">
         <div class="text-lg font-medium">{{ 'extras.account.profile' | transloco }}</div>
        <div class="text-neutral-500">
           {{ 'extras.account.profileDescription' | transloco }}
        </div>
      </div>
      ...
      <div class="col-span-full">
         <div class="text-lg font-medium">{{ 'extras.account.personal' | transloco }}</div>
        <div class="text-neutral-500">
           {{ 'extras.account.personalDescription' | transloco }}
        </div>
      </div>
