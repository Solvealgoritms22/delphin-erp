    ...
    <div class="flex flex-auto items-center justify-center p-4 sm:p-12">
      <mat-card class="flex flex-row">
        ...
        >
          ...
          <!-- Minimalist Glassmorphic Hero Card -->
          <div class="relative z-10 flex flex-col items-center justify-center text-center max-w-xl w-full p-8 sm:p-12 rounded-2xl border border-white/[0.12] bg-[#071326]/60 backdrop-blur-md select-none shadow-2xl">
