  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        route: '/admin/commercial/quotes',
        activeOptions: { exact: false },
        requiredPermission: 'commercial:read',
      },
      {
        id: 'commercial/purchases',
        label: 'nav.purchases',
        icon: 'shopping-cart',
        route: '/admin/commercial/purchases',
        activeOptions: { exact: false },
        requiredPermission: 'commercial:read',
      },
      {
        id: 'commercial/receivables',
        label: 'nav.receivables',
        icon: 'credit-card',
        route: '/admin/commercial/receivables',
        activeOptions: { exact: false },
        requiredPermission: 'commercial:read',
      },
      {
        ...
        icon: 'tag',
        route: '/admin/commercial/promotions',
        activeOptions: { exact: false },
        requiredPermission: 'commercial:read',
      },
      {
