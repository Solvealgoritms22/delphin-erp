  ...
  template: `
    ...
    >
      ...
      >
        ...
        <mat-sidenav-content class="!flex !flex-col h-full min-h-0 bg-white dark:bg-neutral-900 overflow-hidden">
          ...
          @if (!isChildActive()) {
            <div class="flex flex-col flex-1 min-h-0 h-full w-full overflow-hidden">
              ...
              <!-- Header Bar -->
              <div class="flex items-center justify-between border-b border-neutral-200 dark:border-neutral-800 px-4 py-2.5 sm:px-6 bg-white/95 dark:bg-neutral-900/95 backdrop-blur-md shrink-0 z-20">
              ...
              <div class="flex-1 min-h-0 overflow-y-auto px-4 py-6 sm:px-8 flex flex-col justify-between">
                <div class="mx-auto w-full max-w-3xl my-auto py-4">
                  <div class="flex flex-col items-center text-center">
                    ...
                    <h2 class="text-2xl sm:text-3xl font-bold tracking-tight text-neutral-900 dark:text-white">
                      {{ 'aiChat.welcomeTitle' | transloco }}
                    </h2>
                    <p class="mt-1.5 text-xs sm:text-sm text-neutral-500 dark:text-neutral-400 max-w-md">
                  ...
                  <div class="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-2">
                    @for (suggestion of suggestions(); track suggestion.title) {
                      <button
                        class="flex cursor-pointer flex-col gap-y-1 rounded-2xl border border-neutral-200/90 dark:border-neutral-800 bg-neutral-50/50 dark:bg-neutral-800/40 p-4 text-left hover:bg-neutral-100/80 dark:hover:bg-neutral-800 transition-all hover:border-blue-400/50 dark:hover:border-blue-500/50 shadow-2xs group"
                        (click)="sendQuickSuggestion(suggestion.query)"
                      >
                        <div class="flex items-center gap-x-2">
                          <mat-icon [svgIcon]="suggestion.icon" class="size-4 text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform" />
                ...
                <!-- Input Box -->
                <div class="mx-auto w-full max-w-3xl pt-4 pb-2">
                  <div
