                ...
                <div class="clients-grid grid items-center gap-4 py-3 px-6 md:px-8 border-b border-neutral-100 dark:border-neutral-800">
                  ...
                  <div class="hidden sm:block">
                    <span class="inline-flex items-center px-2 py-0.5 rounded-md text-[10px] font-bold tracking-wide"
                      [ngClass]="{
                        'bg-blue-50 text-blue-700 dark:bg-blue-500/10 dark:text-blue-400 border border-blue-200/60 dark:border-blue-500/20': client.tipoDocumento === 'CEDULA' || client.tipoDocumento === 'CÉDULA',
                        'bg-amber-50 text-amber-700 dark:bg-amber-500/10 dark:text-amber-400 border border-amber-200/60 dark:border-amber-500/20': client.tipoDocumento === 'RNC',
                        'bg-neutral-100 text-neutral-700 dark:bg-neutral-800 dark:text-neutral-300 border border-neutral-200/60 dark:border-neutral-700/50': client.tipoDocumento !== 'CEDULA' && client.tipoDocumento !== 'CÉDULA' && client.tipoDocumento !== 'RNC'
                      }">
                      {{ client.tipoDocumento || '—' }}
                    </span>
                  </div>
                  <!-- Solo número de documento -->
                  <div class="text-sm font-mono font-medium text-neutral-700 dark:text-neutral-300">{{ client.numeroDocumento || '—' }}</div>
