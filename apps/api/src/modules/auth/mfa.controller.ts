...
export class MfaController {
  ...
  @UseGuards(JwtAuthGuard)
  @Header('Cache-Control', 'no-store')
  enable(@CurrentUser() user: any, @Body() body: MfaCodeDto) {
    return this.mfa.manage(user, body.code, 'enable');
  }
  @Post('disable')
  @UseGuards(JwtAuthGuard)
  @Header('Cache-Control', 'no-store')
  disable(@CurrentUser() user: any, @Body() body: MfaCodeDto) {
    return this.mfa.manage(user, body.code, 'disable');
  }
  @Post('recovery-codes')
  @UseGuards(JwtAuthGuard)
  @Header('Cache-Control', 'no-store')
  recovery(@CurrentUser() user: any, @Body() body: MfaCodeDto) {
    return this.mfa.manage(user, body.code, 'recovery');
  }
}
