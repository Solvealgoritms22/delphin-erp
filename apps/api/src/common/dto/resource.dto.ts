...
export class UpdateCompanyDto extends PartialType(CompanyDto) {
  ...
  @IsOptional()
  @IsIn(['TOKEN', 'EMAIL', 'OAUTH2'])
  fiscalbridgeAuthMethod?: string;
  @IsOptional() @IsString() @MaxLength(8192) fiscalbridgeToken?: string;
  @IsOptional()
  @ValidateIf((_o, v) => v !== '')
  @IsEmail()
  fiscalbridgeEmail?: string;
...
export class RoleDto {
  @ValidateIf((o) => !o.name || o.nombre !== undefined)
  @IsString()
  @Length(1, 200)
  nombre?: string;
    ...
    validator: {
      validate: (v) =>
        typeof v === 'string'
          ...
          : Array.isArray(v) &&
            v.length <= 5 &&
            v.every((i) => typeof i === 'string' && i.length <= 2000000),
    },
  })
...
export class BillingConfigDto {
  ...
  @IsOptional()
  @IsIn(['HALF_UP', 'HALF_EVEN', 'DOWN', 'UP'])
